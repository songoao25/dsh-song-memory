...
export const zh = {
  ...
  'config.title': '记忆系统设置',
  'config.description': '统一设置常用小抄、项目资料、记忆仓库和 DSH 界面；点击保存后立即生效。',
  ...
  'config.storageDescription': '决定常用小抄、项目文档、song memory 及支持工作区绑定的存储服务是否随当前工作区隔离；其余存储服务保持自身全局作用域。',
  'config.scope': '存储范围',
  ...
  'config.providersTitle': '记忆仓库存储服务',
  ...
  'config.packFullHint': '常用小抄、项目文档与记忆仓库',
  'config.packRuntime': 'Runtime',
  'config.packRuntimeHint': '常用小抄与 USER / MEMORY 投影',
  ...
  'config.packWholeZipHint': '包含常用小抄、项目文档和 song memory 记忆仓库；不包含第三方数据或密钥。',
