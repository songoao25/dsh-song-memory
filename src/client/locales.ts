...
export const zh = {
  ...
  'header.notReady': 'song memory 尚未就绪',
  ...
  'overview.title': '记忆仓库',
  'overview.description': '统一管理 song memory 记忆仓库与第三方存储服务接入的记忆空间；激活后的记忆仓库共同参与读取、路由与实时快照。',
  ...
  'overview.metadataUnavailable': '暂时无法运行：未找到与当前存储位置匹配的活跃 Agent',
  ...
  'overview.mnemonDefault': 'song memory 默认',
  ...
  'overview.emptyLong': '创建一个 song memory 记忆仓库，或在“设置 → 记忆系统”启用第三方存储服务以同步其已有记忆空间。',
  ...
  'overview.candidateNativeReady': '官方原生 · 跟随当前存储位置',
  'overview.providerServiceRequired': '尚未启用；请先前往“设置 → 记忆系统”完成服务设置',
  'overview.workspaceBinding.automatic': '跟随当前存储位置',
  ...
  'overview.candidateLocal': '本地存储服务 · 跟随当前存储位置',
  ...
  'overview.providerTargetUri': '存储位置 URI',
  ...
  'overview.lastStoreDeleteHint': 'song memory 需要保留至少一个原生 Store；可将最后一个记忆仓库设为未激活，但不能删除。',
  ...
  'runtime.title': '常用信息',
  'runtime.description': '管理每轮随上下文加载的紧凑常用信息。结构化数据由统一控制层维护，并自动投影为 USER.md 与 MEMORY.md。',
  'runtime.total': '{count} 条常用信息',
  'runtime.entriesAria': '常用信息列表',
  'runtime.scopeAria': '常用信息范围',
  'runtime.scopeAll': '全部',
  'runtime.filterAria': '筛选常用信息',
  'runtime.filterPlaceholder': '按内容筛选…',
  'runtime.noMatch': '没有符合当前范围与查询条件的常用信息。',
  'runtime.refresh': '刷新',
  'runtime.hotContext': '每轮上下文',
  'runtime.addTitle': '添加常用信息',
  'runtime.addDescription': '稳定但仍需频繁使用的信息优先留在这里，长期归档由 song memory 记忆仓库承接。',
  'runtime.content': '常用信息内容',
  ...
  'runtime.empty': '这个分类还没有常用信息。',
  'runtime.editContent': '编辑常用信息',
  'runtime.editAction': '编辑',
  'runtime.saveEdit': '保存修改',
  'runtime.removeAction': '移除',
  'runtime.removeConfirm': '确认移除这条常用信息？',
  'runtime.removeTitle': '移除常用信息？',
  ...
  'runtime.readOnly': '当前部署为只读模式；常用信息仍会进入上下文，但不能在此修改。',
  'runtime.footnote': 'memories.json 是唯一事实源；两个 Markdown 文件由控制层生成，不应直接编辑。',
  'documents.title': '项目文档',
  'documents.description': '在当前工作区维护结构化的项目文档。活跃项目文档参与近场检索；达到 10 MB 上限前，最久未使用的项目文档会先在 song memory 中建立索引，再迁入归档。',
  ...
  'documents.archived': '已建立 song memory 冷索引并归档；关联记忆仓库：{spaces}',
  ...
  'documents.emptyArchivedText': '只有完成 song memory 索引的项目文档才会迁移到这里。',
  'documents.reader': '项目文档阅读器',
  'documents.selectTitle': '选择一份项目文档',
  'documents.selectText': '在左侧查看活跃项目知识或沿 song memory 引用打开归档原文。',
  ...
  'documents.hash': '内容哈希',
  'documents.size': '文件大小',
  'documents.archiveReceipt': 'song memory 冷索引回执',
  'documents.archiveTitle': '迁入归档',
  'documents.archiveDescription': '先由受限的后台 AI 小助手写入可检索的 song memory 摘要和精确路径，成功后才移动原文。',
  'documents.archive': '归档',
  'documents.archiveConfirm': '确认建立 song memory 索引并迁移这份项目文档？',
  ...
  'graph.aria': 'song memory 实时记忆关系图，{nodes} 个元素，{edges} 条连接',
  ...
  'card.clone': '基于此新建',
  'card.forget': '忘记',
  'turnTail.label': '记忆系统 · 本回合记忆',
  'turnTail.recall': '搜索 {count}',
  ...
  'remember.readOnlyText': '当前部署禁止记忆写入；如需调整，请修改 DSH 的 song memory 设置并保存。',
  ...
  'remember.flowText': '后台 AI 小助手只拥有完成任务所需的 song memory 工具，原始目录和检索过程不会进入主对话上下文。',
  ...
  'status.title': '系统状态',
  'status.description': '聚焦 dsh-song-memory、各记忆存储服务、三层存储和当前读写目录；连接设置由 DSH 部署统一管理。',
  'status.nominal': '系统正常',
  'status.checkRequired': '需要检查',
  'status.rechecking': '检查中…',
  'status.recheck': '重新检查',
  'status.aria': 'song memory 运行状态',
  'status.engine': '记忆引擎',
  'status.engineConnected': 'song memory 已连接',
  'status.engineUnavailable': 'song memory 不可用',
  'status.engineChecking': '正在检查本地引擎',
  'status.versionWaiting': '等待版本信息',
  'status.pluginChecking': '正在检查插件状态',
  'status.pluginReady': '插件运行正常',
  'status.nativeAria': 'song memory 原生存储状态',
  ...
  'versions.description': '检查 Mnemon CLI 与 dsh-song-memory；只有识别到受支持的安装方式时才会提供更新操作。',
  ...
  'versions.restartRequired': '请重启 dsh web，以加载新的 dsh-song-memory 插件代码。',
  ...
  'status.storageDomainsText': '当前选择决定常用信息、记忆仓库和项目文档共同使用的目录边界。',
  ...
  'config.aria': '记忆系统设置',
  'config.tab': 'song memory',
  'config.title': '记忆系统',
  'config.description': '统一设置常用信息、项目资料、记忆仓库和 DSH 界面；点击保存后立即生效。',
  'config.forkTitle': '来源与命名',
  'config.forkNotice': '本插件是 dsh-mnemon（MIT，Copyright © 2026 dsh-external contributors）的界面重做分支 song memory：底层引擎、9 种存储服务与所有功能保持原样，仅界面文案与命名做了白话化。数据目录 ~/.mnemon、命令行 mnemon、备份格式 .mnemonpack 均沿用上游技术名（非品牌名），以保证旧数据与备份兼容。',
  'config.unsaved': '有未保存修改',
  'config.ready': '已保存并实时生效',
  'config.noticeBefore': '设置写入',
  'config.noticeAfter': '；所有设置点击保存后实时生效。切换范围不会自动迁移旧内容。',
  'config.displayTitle': '记忆页面位置',
  'config.displayDescription': '选择记忆系统在 DSH Web 中的入口位置；切换后立即生效。',
  'config.displayAria': '记忆页面位置',
  'config.displaySidebar': '侧边栏',
  'config.displaySidebarHint': '在左侧边栏打开记忆系统',
  'config.displayBuildin': '对话区标签页',
  'config.displayBuildinHint': '在对话区、信息概览旁边显示记忆系统',
  'config.storageTitle': '存储位置',
  'config.storageDescription': '决定常用信息、项目文档、song memory 及支持工作区绑定的存储服务是否随当前工作区隔离；其余存储服务保持自身全局作用域。',
  'config.scope': '存储范围',
  ...
  'config.providersTitle': '存储服务',
  'config.providersDescription': '在这里启用并设置存储服务。启用或保存会同步服务中已有的记忆空间；关闭会移除本地映射，但不会删除第三方数据。范围标签显示当前生效边界。',
  'config.nativeSummary': '官方原生长期记忆与完整关系图',
  'config.officialNative': '官方原生',
  'config.nativeGlobalLocation': '全局数据位置',
  'config.nativeGlobalLocationHint': 'song memory 的全局范围可以使用默认目录或指定一个目录。',
  ...
  'config.providerDefaultName': '{provider} 记忆仓库',
  'config.providerDefaultDescription': '由 dsh-song-memory 使用的 {provider} 长期记忆。',
  'config.newProviderConfig': '新记忆仓库设置',
  ...
  'config.providerMemoryName': '记忆仓库名称',
  'config.providerMemoryDescription': '用途说明',
  'config.providerSaveFailed': '设置保存失败：{error}',
  'config.providerSaved': '设置已保存',
  'config.createAndEnable': '保存并启用',
  'config.saveProviderConfig': '保存设置',
  'config.addProviderConfig': '添加一份记忆仓库设置',
  'config.providerNotConfigured': '未设置',
  'config.providerConfiguredCount': '{count} 份设置',
  'config.providerServiceTitle': '服务设置',
  'config.providerServiceHint': '供该存储服务的所有记忆仓库复用；启用或保存时会刷新记忆仓库目录中的映射与元信息。',
  'config.providerEnableHint': '填写服务设置并保存后，存储服务会启用并同步所有可见记忆空间。',
  'config.providerServiceConfigured': '服务已设置',
  'config.providerServiceNotConfigured': '服务未设置',
  'config.providerEnabled': '已启用',
  'config.providerDisabled': '未启用',
  'config.providerDisabledConfigured': '已关闭 · 设置已保留',
  'config.providerNeedsConfiguration': '需要完成设置',
  'config.providerToggleAria': '启用 {provider}',
  'config.providerToggleFailed': '切换失败：{error}',
  'config.enableProvider': '保存并启用',
  'config.providerServiceSaved': '服务设置已保存，记忆仓库目录已同步',
  'config.saveProviderService': '保存服务设置',
  'config.providerUnavailable': '当前 DSH 主机不支持存储服务设置。',
  'config.saveScopeBeforeProviders': '存储范围有未保存修改。请先保存范围，再设置对应目录中的存储服务。',
  'config.providerTargetWorkspace': '当前工作区：{workspace}；标记“工作区”的存储服务设置与记忆仓库使用此范围。',
  'config.loadingProviders': '正在读取存储服务设置…',
  'config.providerLoadFailed': '读取存储服务设置失败：{error}',
  'config.retryProviders': '重试',
  'config.taskAgentTitle': '后台助手',
  'config.taskAgentDescription': 'AI 元信息、助手查询、记忆保存和资料归档使用无会话历史的独立后台助手；这里只调整这些后台任务的模型路由。',
  'config.taskAgentModeAria': '后台助手模型路由',
  'config.taskAgentInherit': '跟随主链路',
  'config.taskAgentInheritHint': '使用 DSH 新会话默认模型',
  'config.taskAgentFixed': '指定模型服务',
  'config.taskAgentFixedHint': '为 song memory 后台任务固定路由',
  'config.taskAgentProvider': '模型服务',
  'config.taskAgentProviderHint': '选择 DSH 已设置的模型服务',
  'config.taskAgentModel': '模型',
  'config.taskAgentModelHint': '选择该模型服务下的完整模型路由',
  'config.taskAgentChooseProvider': '选择模型服务',
  'config.taskAgentChooseModel': '选择模型',
  'config.taskAgentEffective': '当前将使用',
  'config.taskAgentLoading': '正在读取模型目录',
  'config.taskAgentUnavailable': '尚无可用的模型服务 / 模型路由',
  'config.taskAgentLoadFailed': '模型目录读取失败：{error}',
  'config.taskAgentPartial': '有 {count} 个模型服务暂时无法读取，其他选项仍可使用。',
  'config.taskAgentRouteRequired': '指定后台任务模型时，必须同时选择模型服务和模型。',
  'config.customPack': '自定义 Pack',
  'config.customPackAria': '选择自定义 song memory 备份包',
  'config.customPackRequired': '请选择或添加一个自定义 Pack。',
  'config.customDefaultName': '自定义 Pack',
  'config.noCustomPacks': '尚未设置备份包',
  ...
  'config.customHint': '整个 song memory 数据都位于此处。',
  'config.customAria': 'song memory 自定义数据目录',
  ...
  'config.packUnavailable': '当前 DSH 主机不支持 song memory ZIP 备份通道。',
  'config.packFull': '整体 Pack',
  'config.packFullHint': '常用信息、项目文档与记忆仓库',
  'config.packRuntime': 'Runtime',
  'config.packRuntimeHint': '常用信息与 USER / MEMORY 投影',
  'config.packDocuments': 'Documents',
  'config.packDocumentsHint': '项目文档、归档与索引',
  'config.packMemorySpaces': '记忆仓库',
  ...
  'config.packFormatHint': '统一使用 .mnemonpack（ZIP + manifest + SHA-256）；记忆仓库仍以独立 mnemon.db 保存在包内。',
  'config.packPreviewEyebrow': '导入预览',
  'config.packUnnamed': '未命名 song memory 备份包',
  ...
  'config.packSimpleDescription': '备份或恢复当前 song memory 数据；第三方存储服务数据仍由对应服务管理。',
  'config.packWholeZip': '当前目录 ZIP',
  'config.packWholeZipHint': '包含常用信息、项目文档和 song memory 记忆仓库；不包含第三方数据或密钥。',
  'config.packImportZip': '导入 ZIP',
  'config.packExportZip': '导出 ZIP',
  'config.packChooseZip': '选择 song memory 备份 ZIP',
  'config.packUnnamedZip': 'song memory 备份.zip',
  ...
  'nav.cheatsheet': '常用信息',
  'nav.cheatsheet.detail': '关于我、关于项目的常用信息',
...
export const en = {
  ...
  'nav.runtime': 'Frequent Info',
  'nav.runtime.detail': 'Frequent Info and context',
  ...
  'header.notReady': 'Song Memory is not ready',
  ...
  'overview.description': 'Manage Song Memory stores and third-party storage service namespaces together. Active spaces participate in unified reads, routing, and live snapshots.',
  ...
  'overview.mnemonDefault': 'Song Memory default',
  ...
  'overview.emptyLong': 'Create a Song Memory store, or enable a third-party storage service in Settings → Memory System to synchronize its existing namespaces.',
  ...
  'overview.lastStoreDeleteHint': 'Song Memory must retain at least one native Store. The last memory store may be inactive, but it cannot be deleted.',
  ...
  'runtime.entriesAria': 'Frequent Info list',
  'runtime.scopeAria': 'Frequent Info scope',
  ...
  'runtime.addDescription': 'Keep stable, frequently useful information here; Song Memory stores remain the durable archive.',
  'runtime.content': 'Frequent Info content',
  ...
  'runtime.readOnly': 'This deployment is read only. Frequent Info still enters context but cannot be changed here.',
  ...
  'documents.description': 'Maintain structured project documents in the current workspace. Active documents support near-field search; before the 10 MB limit is exceeded, the least-recently-used document is indexed in Song Memory and moved to the archive.',
  'documents.capacity': '{used} / {limit}',
  ...
  'documents.archived': 'Song Memory cold index created and document archived; Memory Stores: {spaces}',
  ...
  'documents.emptyArchivedText': 'Only documents with a completed Song Memory index are moved here.',
  'documents.reader': 'Document reader',
  'documents.selectTitle': 'Select a document',
  'documents.selectText': 'Read active project knowledge or follow a Song Memory reference to an archived original.',
  ...
  'documents.archiveReceipt': 'Song Memory cold-index receipt',
  'documents.archiveTitle': 'Move to archive',
  'documents.archiveDescription': 'A restricted background AI helper first stores a searchable Song Memory summary and exact path. The original moves only after that succeeds.',
  'documents.archive': 'Archive',
  'documents.archiveConfirm': 'Create the Song Memory index and archive this document?',
  ...
  'graph.aria': 'Song Memory live memory relation map with {nodes} elements and {edges} edges',
  ...
  'card.forget': 'Forget',
  'turnTail.label': 'Memory System · Turn memory',
  ...
  'remember.readOnlyText': 'This deployment disables memory writes. Change and save the DSH Song Memory configuration to enable them.',
  ...
  'remember.flowText': 'The background AI helper receives only the Song Memory tools it needs, keeping the raw directory and retrieval process out of the main context.',
  ...
  'status.description': 'dsh-song-memory, memory storage services, three-tier storage, and the current read/write root. DSH deployment owns connection configuration.',
  'status.nominal': 'System nominal',
  'status.checkRequired': 'Check required',
  'status.rechecking': 'Checking…',
  'status.recheck': 'Check again',
  'status.aria': 'Song Memory runtime status',
  'status.engine': 'Memory engine',
  'status.engineConnected': 'Song Memory connected',
  'status.engineUnavailable': 'Song Memory unavailable',
  ...
  'status.nativeAria': 'Song Memory native storage status',
  ...
  'versions.description': 'Check Mnemon CLI and dsh-song-memory. Updates are offered only for a recognized, supported installation.',
  ...
  'versions.restartRequired': 'Restart dsh web to load the new dsh-song-memory plugin code.',
  ...
  'status.storageRuntime': 'Frequent Info',
  ...
  'config.tab': 'Song Memory',
  'config.title': 'Memory System',
  'config.description': 'Configure runtime memory, project Documents, Memory Stores, and the DSH interface together. Changes apply immediately after Save.',
  'config.forkTitle': 'Origin & naming',
  'config.forkNotice': 'This plugin is song memory, a UI-redesign fork of dsh-mnemon (MIT, Copyright © 2026 dsh-external contributors): the underlying engine, all 9 storage services, and every feature remain unchanged; only the interface copy and naming were simplified. The data directory ~/.mnemon, the mnemon CLI, and the .mnemonpack backup format keep their upstream technical names (not brand names) to stay compatible with existing data and backups.',
  ...
  'config.displayTitle': 'Memory page location',
  'config.displayDescription': 'Choose where the memory system appears in DSH Web. Switching modes applies immediately.',
  'config.displayAria': 'Memory page location',
  'config.displaySidebar': 'Sidebar',
  'config.displaySidebarHint': 'Dedicated workspace in the sidebar',
  'config.displayBuildin': 'Built-in tab',
  'config.displayBuildinHint': 'Show the memory system next to the overview in the conversation area',
  'config.storageTitle': 'Storage location',
  'config.storageDescription': 'Choose whether Runtime, Documents, song memory, and workspace-aware storage services follow the current workspace. Other storage services keep their own global scope.',
  ...
  'config.providersTitle': 'Storage services',
  'config.providersDescription': 'Enable and configure storage services here. Enabling or saving synchronizes existing service namespaces; disabling removes local mappings without deleting third-party data. Scope tags show the active boundary.',
  ...
  'config.nativeGlobalLocationHint': 'song memory can use its default global directory or a directory you choose.',
  ...
  'config.providerDefaultName': '{provider} Memory Store',
  'config.providerDefaultDescription': '{provider} long-term memory used by dsh-song-memory.',
  'config.newProviderConfig': 'New Memory Store setup',
  ...
  'config.providerMemoryName': 'Memory Store name',
  ...
  'config.addProviderConfig': 'Add a Memory Store setup',
  ...
  'config.providerServiceHint': 'Shared by this storage service’s Memory Stores; enabling or saving refreshes their directory mappings and metadata.',
  'config.providerEnableHint': 'Complete and save the service settings to enable the storage service and synchronize every visible namespace.',
  ...
  'config.providerToggleFailed': 'Could not change service state: {error}',
  'config.enableProvider': 'Save and enable',
  'config.providerServiceSaved': 'Service settings saved and Memory Stores synchronized',
  'config.saveProviderService': 'Save service configuration',
  'config.providerUnavailable': 'This DSH host does not support storage service settings.',
  'config.saveScopeBeforeProviders': 'The storage scope has unsaved changes. Save the scope before setting up storage services in that directory.',
  'config.providerTargetWorkspace': 'Current workspace: {workspace}. Storage services tagged Workspace use this scope for settings and Memory Stores.',
  'config.loadingProviders': 'Loading storage service settings…',
  'config.providerLoadFailed': 'Could not load storage service settings: {error}',
  'config.retryProviders': 'Retry',
  'config.taskAgentTitle': 'Background assistant',
  'config.taskAgentDescription': 'AI metadata, assistant queries, memory saving, and document archiving use clean independent background assistants. This setting changes only their model route.',
  'config.taskAgentModeAria': 'Background assistant model route',
  'config.taskAgentInherit': 'Follow the main route',
  'config.taskAgentInheritHint': 'Use the DSH new-session default model',
  'config.taskAgentFixed': 'Choose model service',
  'config.taskAgentFixedHint': 'Pin song memory background tasks to one route',
  'config.taskAgentProvider': 'Model service',
  'config.taskAgentProviderHint': 'Choose a model service configured in DSH',
  'config.taskAgentModel': 'Model',
  'config.taskAgentModelHint': 'Choose a complete model route from that service',
  'config.taskAgentChooseProvider': 'Choose service',
  ...
  'config.taskAgentUnavailable': 'No model service or model route is currently available',
  'config.taskAgentLoadFailed': 'Could not load the model directory: {error}',
  'config.taskAgentPartial': '{count} model services could not be read; the remaining options are still available.',
  'config.taskAgentRouteRequired': 'Choose both a model service and a model for a fixed background-task route.',
  'config.customPack': 'Custom Pack',
  'config.customPackAria': 'Select a custom song memory backup pack',
  ...
  'config.customHint': 'The complete song memory data lives here.',
  'config.customAria': 'song memory custom data directory',
  ...
  'config.interactionTitle': 'In-conversation display',
  ...
  'config.interactionTurnBarHint': 'Show retrieval, write, and search activity below each turn',
  'config.interactionSaveAction': 'Save to memory action',
  'config.interactionSaveActionHint': 'Add supervised memory saving beside finalized replies',
  'config.interactionOn': 'Enabled',
  'config.packTitle': 'Backup',
  ...
  'config.packUnavailable': 'This DSH host does not provide the song memory ZIP backup channel.',
  'config.packFull': 'Complete Pack',
  'config.packFullHint': 'Runtime, Documents, and Memory Stores',
  'config.packRuntime': 'Runtime',
  'config.packRuntimeHint': 'Cheat sheet and USER / MEMORY projections',
  'config.packDocuments': 'Documents',
  'config.packDocumentsHint': 'Project documents, archive, and index',
  'config.packMemorySpaces': 'Memory Stores',
  ...
  'config.packFormatHint': 'Uses .mnemonpack throughout (ZIP + manifest + SHA-256). Each Memory Store remains a separate mnemon.db inside the pack.',
  'config.packPreviewEyebrow': 'Import preview',
  'config.packUnnamed': 'Unnamed song memory backup pack',
  ...
  'config.packSimpleDescription': 'Back up or restore the current song memory data. External service data remains managed by its own service.',
  'config.packWholeZip': 'Current directory ZIP',
  'config.packWholeZipHint': 'Includes Runtime, Documents, and song memory stores; excludes external data and credentials.',
  'config.packImportZip': 'Import ZIP',
  'config.packExportZip': 'Export ZIP',
  'config.packChooseZip': 'Choose a song memory backup ZIP',
  'config.packUnnamedZip': 'song memory backup.zip',
  ...
  'nav.cheatsheet': 'Frequent Info',
  'nav.cheatsheet.detail': 'Frequent Info about me and the project',
